...
export default function Home() {
    ...
    return (
        <main className="flex flex-col w-full font-sans bg-transparent dark:bg-transparent transition-colors duration-300">
            {/* HERO SECTION - SINGLE FULL-WIDTH CARD */}
            <section className="w-full bg-transparent pt-8 pb-12">
                <div className="max-w-7xl mx-auto px-4 xl:pr-[380px]">
                    <div className="w-full rounded-[16px] bg-gray-900 relative overflow-hidden h-[600px] flex flex-col justify-center shadow-lg group">
                        ...
                        {heroSlides.map((slide, index) => (
                            ...
                            >
                                ...
                                {/* Content container with 32px padding */}
                                <div className="relative z-20 w-full max-w-2xl h-full flex flex-col justify-center p-[32px]">
